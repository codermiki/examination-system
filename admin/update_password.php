...
if (!isset($_SESSION['email']) || !isset($_SESSION['role']) || $_SESSION['role'] !== 'admin' || !isset($_SESSION['user_id'])) {
...
<div class="container">
    <div class="form__container">
        ...
        <form action="handle_action.php?action=admin_update_password" method="POST">
